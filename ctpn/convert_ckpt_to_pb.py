...
def freeze_graph(input_checkpoint,output_graph):
    ...
    output_node_names = "rpn_bbox_pred/weights,rpn_bbox_pred/biases,rpn_cls_score/weights,rpn_cls_score/biases"
...
input_checkpoint='checkpoints/VGGnet_fast_rcnn_iter_50000.ckpt'
